// Funcionalidades para la página de máquinas del líder
class MaquinasLiderManager {
    constructor() {
    ...
    async fetchMachineData(machineId) {
        const response = await fetch(`/lider/maquinas/${machineId}/detalles`, {
            method: 'GET',
            headers: {
